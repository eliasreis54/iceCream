...
class DojoChannel extends ApplicationChannel {
  ...
  Future prepare() async {
    ...
    final config = DojoConfiguration(options.configurationFilePath);
...
class DojoConfiguration extends Configuration {
  DojoConfiguration(String fileName) : super.fromFile(File(fileName));
